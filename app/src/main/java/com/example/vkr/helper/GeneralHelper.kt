package com.example.vkr.helper
    ...
    companion object{
        ...
        fun updateNotification(context: Context, service: Service, step: Int){
            ...
            var notification = NotificationCompat.Builder(context, "CHANNEL_ID")
                ...
                .setStyle(NotificationCompat.BigTextStyle().bigText("Сегодня вы прошли "))
                .setStyle(NotificationCompat.BigTextStyle().bigText("$step шагов"))
                .setSmallIcon(R.drawable.zastavkaxxx)
                .setContentIntent(pendingIntent)
                .setProgress(StorageSetting.stepMax.toInt(), step, false)//максимальное число прогресссбара
