...
class HolderTreningAdmin (inflater: LayoutInflater, parent: ViewGroup) :
        RecyclerView.ViewHolder(inflater.inflate(R.layout.item_client_trening, parent, false)) {
        ...
        init {
            mImg=itemView.findViewById(R.id.img_client_trening)
            mTip=itemView.findViewById(R.id.tip)
            mTitle=itemView.findViewById(R.id.title)
            mOpisanie=itemView.findViewById(R.id.opisanie)
            mCountex=itemView.findViewById(R.id.countex)
            mTimetr=itemView.findViewById(R.id.timetr)
        }
